...
The block top menu is the default top menu module for your shop

## Description

The block top menu is the default top menu module for your shop. This module is included in all thirty bees installation.
