...
The block store module adds a store link to your site

## Description

The block store module adds a store link to the left or right column of your site. The module links to the built in store locator page.
