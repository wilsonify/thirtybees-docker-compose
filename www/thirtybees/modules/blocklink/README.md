...
The block link allows you to add a menu of custom links to your site.

## Description

The block link allows you to add a list of custom links to your left column, right column or header of your site.
